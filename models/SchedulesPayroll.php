...
, concat(SE.SECTION,'-',SE.SectionId) SECTION
, SE.SERIAL_ID
, SE.PROGRAM
...
, SE.EVENT_STATUS
, SE.ADDS
, IIF(DATEDIFF(MINUTE, SSC.START_TIME, SSC.END_TIME) IS NULL, 'DOM',SSC.DAY) DAY
, IIF(DATEDIFF(MINUTE, SSC.START_TIME, SSC.END_TIME) IS NULL, '0',
CASE SSC.DAY WHEN 'DOM' THEN '0' WHEN 'LUN' THEN '1' WHEN 'MAR' THEN '2' WHEN 'MIE' THEN '3' WHEN 'JUE' THEN '4' WHEN 'VIE' THEN '5' WHEN 'SAB' THEN '6' 
    ELSE '' END) CODE_DAY 
